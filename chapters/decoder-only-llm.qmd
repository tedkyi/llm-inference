...
As the sequence gets longer and we have **[S]{.dim-s}** > 8192, then these dimensions will be longer, despite this static diagram not being able to dynamically show the change.
...
They also have the concept of always-on experts called **shared experts**. @Fig-moe-flow shows what the vanilla data flow looks like with an MoE configuration with 6 total experts, 2 of which are active.
