...
**Attention kernels.**
Tri Dao's blog post accompanying the FlashAttention-3 paper [@dao2024flash3blog] is more accessible than the papers themselves and gives a clear walkthrough of how tiling, asynchronous memory transfers, and FP8 computation work together on Hopper hardware.
It's a good starting point before diving into the academic papers.

**Kernel-level optimizations.**
For a practical look at how CUDA graphs reduce kernel-launch overhead in LLM decode loops, NVIDIA's blog post on optimizing llama.cpp with CUDA graphs [@nvidia2024cudagraphs] walks through the implementation and reports concrete latency improvements.
