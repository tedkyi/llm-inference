...
Simple PTQ only examines the weights, and more advanced techniques require processing a small set of calibration data through the model so activation information can also be analyzed.
