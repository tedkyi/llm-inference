...
We recommend that you examine @tip-conventions at the beginning of @sec-forward-pass to understand the conventions used in tensor data flow diagrams before moving ahead to the rest of the book.
...
::: {#tip-conventions .callout-tip}
Before diving into the data flow, here are a few conventions used in the tensor data flow diagrams.
Abbreviations and colors are listed in frontmatter in the **Conventions** section.
