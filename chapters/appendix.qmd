...
(A copy of the listing can be downloaded from the [book repo source](https://tedkyi.github.io/llm-inference/chapters/images/attn_code.py), and the full LLM implementation can be reviewed in the nanoGPT repo.)
