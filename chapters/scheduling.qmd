...
DeepSpeed-FastGen [@holmes2024deepspeedfastgen] introduces Dynamic SplitFuse, an approach closely related to chunked prefill that decomposes prefill requests and composes them with decode tokens to maintain consistent forward pass sizes, with a detailed performance analysis on Microsoft's DeepSpeed infrastructure.
