...
Ignoring the batch and sequence dimensions, each GPU receives the full input activation $x$ of shape **($\dimd{d_{\text{in}}}$)** and computes $x W_i$ locally, producing a partial output slice of shape **($\dimd{d_{\text{out}}}$/T)**.
