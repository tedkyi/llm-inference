...
The first thing that happens is the LLM runs a single **forward pass** of the neural network model using all of the input tokens. After processesing all of these tokens together, it produces its prediction for the next token, **over**. This initial step is shown in @fig-inference-start.
