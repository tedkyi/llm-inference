...
The top row of @fig-kv-variants shows a how queries align with keys and values in MHA.
...
![Full causal attention (left) vs. sliding window attention with window size w=4 (right). Each shaded cell indicates a query-key pair included in the attention computation.](images/sliding_window.svg){#fig-sliding-window-attn .lightbox}
