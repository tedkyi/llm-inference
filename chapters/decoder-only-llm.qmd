...
We are modeling this conceptually at this time, and we will see in @sec-kv-cache-intro that a fundamental optimization will implement this orange path in data store called the KV cache.
