...
2.  Once again, the predicted token **the** is appended to the end, the model is fed **"The quick brown fox jumps over the"**, and it predicts **lazy**.
...
Without any optimization, a single request to a 70B model might generate only 15–20 tokens per second on a high-end GPU, and frontier models like Gemini, believed to be ten times larger, would be below 2 tokens per second.
