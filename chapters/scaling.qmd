...
![Column-parallel linear layer calculation for 2-way tensor parallelism with a $W_{\text{Up}}$ matrix](images/tp_column.svg){#fig-tp-column .lightbox}
...
![Row-parallel linear layer calculation for 2-way tensor parallelism with a $W_{\text{Down}}$ matrix](images/tp_row.svg){#fig-tp-row .lightbox}
