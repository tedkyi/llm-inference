...
![Memory access pattern for a straitforward implementation of self-attention](images/std_attn_hbm.svg){#fig-std-attn-hbm .lightbox}
...
They report succes squeezing entries down to 3.5 bits without hurting LLM performance.
