...
While cost per token is often measured in aggregate, it can also be useful to break out cost betweeen input and output tokens, or between prefill and decode.
