...
Let's walk through the stages needed to load an LLM and process a user request. We will break this down into four stages that have distinct properties in terms of when they happen, where they happen, and what kinds of resources they consume. These stages are shown in @fig-pipeline-stages.
