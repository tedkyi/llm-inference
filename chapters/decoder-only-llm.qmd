...
-->
```
![KV cache. TODO: this diagram needs to be completely redesigned.](images/kv_cache.svg){#fig-kv-cache}
...
![Data flow for multi-head attention when using a KV cache](images/attn_flow_kv.svg){#fig-attn-flow-kv}
...
-->
```
![Data flow of weights and activations in an MOE MLP layer. TODO: this figure needs more work.](images/moe_flow.svg){#fig-moe-flow}
