...
With **P** pipeline stages, the activation tensor passed between stages has shape **([S]{.dim-s}, [D]{.dim-d})**, and it only happens **P** -- 1 times, resulting in a much smaller volume of communication (and hit to TPOT) than the 2 × **[L]{.dim-l}** all-reduce operations in TP.
